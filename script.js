...
(function() {
  ...
  function initialiseSpeedsHighlights() {
    ...
    W.map.olMap.events.register('zoomend', null, highlightSpeedsSegments);
    W.map.olMap.events.register('changelayer', null, changeLayer);

    //W.map.events.register("movestart", null, highlightSpeedsSegments);
    //W.map.events.register("move", null, highlightSpeedsSegments);
    W.map.olMap.events.register('moveend', null, highlightSpeedsSegments);
